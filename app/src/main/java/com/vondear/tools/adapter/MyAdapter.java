...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
  ...
  public List<ModelContactCity> datas = null;
  private ItemClickCallBack clickCallBack;

  public MyAdapter(List<ModelContactCity> datas) {
    this.datas = datas;
  }

  public void notifyData(List<ModelContactCity> datas) {
  ...
  public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View view) {
      super(view);
      mTextView = (TextView) view.findViewById(R.id.city_tip);
    }
  }
}
